...
CREATE TABLE tblTaiKhoanKhachHang (
...
CREATE TABLE tblGiaoDichKhachHang (
    ...
    FOREIGN KEY (MaTaiKhoan) REFERENCES tblTaiKhoanKhachHang(MaTaiKhoan),
...
-- Thêm dữ liệu vào bảng TaiKhoanKhachHang
INSERT INTO tblTaiKhoanKhachHang (MaTaiKhoan, HoTenKhachHang, DiaChiKhachHang, ChungMinhNhanDan, SoHieuBuuCucMoTaiKhoan, NgayMoTaiKhoan)
VALUES 
...
SELECT * FROM tblTaiKhoanKhachHang;
